...
<%
String no = request.getParameter("no"); //받고
ProductBean bean = productMgr.getProduct(no); //db에서 일고
%>
<!DOCTYPE html>
<html>
<head>
...
<table style="width: 80%">
	<tr>
		...
		<td style="width: 50%">
			<table style="width: 100%">
				...
				<tr>
					<td>주문 수:</td>
					<td><input type="text" name="quantity" value="1" size="5" style="text-align: center;"></td>
				</tr>
			</table>
		</td>
	...
	<tr>
		<td colspan="3">
			...
			<input type="button" value="이전으로 이동하기" onclick="history.back()">
			</td>
	</tr>
	</table>
</form>
